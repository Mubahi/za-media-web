    ...
    return (
        <header className="bg-gradient-to-l from-black to-gray-300 p-2 px-4 fixed w-full">
            <div className="flex flex-col md:flex-row items-center justify-between">
                ...
                <div className="mb-4 md:mb-0">
                    <button onClick={onLogout} className="border-2 border-red-500 bg-red-500 text-white py-1 px-2 w-full md:w-auto rounded-md hover:bg-white hover:text-red-500 hover:border-red-500 transition duration-300 outline-none ml-2 flex items-center bona-nova-regular">
