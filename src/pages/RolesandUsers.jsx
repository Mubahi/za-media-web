        ...
        {ShowUserForm ? (
          ...
          <div className="flex flex-col justify-center items-center">
            ...
            <button
              ...
              className="bg-yellow-500 text-white py-1 px-3 rounded-md hover:bg-orange-500 hover:text-white hover:border-orange-500 transition duration-300 font-semibold roboto-mono w-full mt-2"
            >
              BACK
            </button>
          </div>
          ...
          <div>
            <h1 className="text-3xl font-bold mb-4 text-center text-orange-800">
              Module Table for {SelectedUserRole}
            </h1>
          ...
          <div>
            ...
            <div className="relative mt-4 flex items-center justify-between bg-yellow-100 border-2 border-red-500 rounded-md px-1">
              <input
                ...
                placeholder=""
                required
                className="text-black peer placeholder-transparent bg-yellow-100 w-auto py-2 px-3 focus:outline-none inputFeild"
              />
              <label
                className="text-black font-mono peer-placeholder-shown:text-base peer-placeholder-shown:text-black peer-placeholder-shown:top-2 peer-focus:-top-6 peer-focus:text-black peer-focus:text-sm absolute left-2 -top-6 cursor-text transition-all"
                htmlFor="userRole"
                name="userRole"
              >
                Enter role
              ...
              <button
                ...
                className="border-2 border-yellow-500 bg-yellow-500 text-white py-1 px-3 rounded-md hover:bg-orange-500 hover:text-white hover:border-orange-500 transition duration-300 font-semibold roboto-mono flex justify-center items-center"
              >
                  ...
                  {RolesList.map((r, index) => (
                    <tr key={index}>
                      ...
                      <td className="border border-slate-300">
                        <button
                          onClick={() => handleUserButtonClick(r)}
                          className=""
                        >
                          <svg
                            ...
                            height="16"
                            fill="currentColor"
                            className="text-orange-500 hover:text-orange-600 bi bi-person-fill"
                            viewBox="0 0 16 16"
                          >
