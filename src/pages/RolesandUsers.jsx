                                        ...
                                        <tr key={index}>
                                            ...
                                            <td className="border border-slate-300">
                                                <button onClick={() => handleUserButtonClick(r)} className="">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="text-orange-500 bi bi-person-fill" viewBox="0 0 16 16">
                                            ...
                                            <td className="border border-slate-300">
                                                <button onClick={() => handleEditRole(index)}>
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="text-orange-500 bi bi-pencil-fill" viewBox="0 0 16 16">
