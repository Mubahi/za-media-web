        ...
        <div className="min-h-screen flex items-start justify-center">
          <div className="bg-white p-6 rounded-lg w-full shadow-md flex border-t-4 border-orange-500">
            ...
            <table className="w-full">
              ...
              <tbody>
                <tr>
                  <th className="font-bold flex justify-start text-orange-600 border-b  border-orange-500 pb-2">
                    SHOP NAME
                  </th>
                  <th className="text-orange-600 border-b text-start border-orange-500 pb-2 pl-5">
                    {shop.shop_name}
                  </th>
                </tr>
                <tr>
                  <th className="font-bold text-orange-600 flex justify-start border-b  border-orange-500 pb-2">
                    COUNTRY
                  </th>
                  <th className="text-orange-600 border-b text-start border-orange-500 pb-2 pl-5">
                ...
                <tr className="border-b border-orange-500 pb-2">
                  <th className="font-bold text-orange-600 flex justify-start ">
                    BRANDS
                  </th>
                    ...
                    <table className="table-auto w-full">
                      <thead>
                        <tr>
                          ...
                          <th className="bg-orange-200 w-1/4 px-2">
                            Total Products
                          </th>
                          <th className="bg-orange-200 w-1/4 px-2">
                      ...
                      <tbody>
                        {shop_brands.map(function (brand) {
                          return (
                            <tr>
                              <th className="border border-gray-300 text-center px-2 text-orange-600 w-1/4">
                                {brand.name}
                              </th>
                ...
                <tr className="border-b border-orange-500">
                  <th className="font-bold text-orange-600 flex justify-start pb-2">
                    PRODUCTS
                  </th>
                    ...
                    <table className="table-auto w-full">
                      <thead>
                        <tr>
                          ...
                          <th className="bg-orange-200 px-2  w-1/3">
                            Total Products
                          </th>
                          <th className="bg-orange-200 px-2  w-1/3">
                            Out of Stock Products
                      ...
                      <tbody>
                        {shop_categories.map(function (category) {
                          return (
                            <tr>
                              <th className="border border-gray-300 text-center px-2 text-orange-600 w-1/3">
                                {category.name}
                              </th>
